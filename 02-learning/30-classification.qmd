...
rate is the quantity of interest,
- **compute** accuracy, sensitivity, specificity, and precision from a
confusion matrix, and **compute** log loss from predicted class probabilities,
and **interpret** what each one measures, and
